...
export class CreatePatientComponent {
  ...
  resuscitationOptions = [
    ...
    {
      label: 'Face mask ventilation (incl. Neopuff)',
      value: 'Face mask ventilation (incl. Neopuff)',
    },
    {
      label: 'Endotracheal tube ventilation',
      value: 'Endotracheal tube ventilation',
    },
  ...
  modeOfDeliveryOptions = [
    ...
    {
      label: 'Caesarean section (elective)',
      value: 'Caesarean section (elective)',
    },
    {
      label: 'Caesarean section (emergency)',
      value: 'Caesarean section (emergency)',
    },
    { label: 'Unknown', value: 'Unknown' },
  ];
  outcomeStatusOptions = [
    ...
    {
      label: 'Discharged to surgical ward',
      value: 'Discharged to surgical ward',
    },
    {
      label: 'Discharged to medical ward',
      value: 'Discharged to medical ward',
    },
    {
      label: 'Transferred to another hospital',
      value: 'Transferred to another hospital',
    },
    { label: 'Died', value: 'Died' },
    {
      label: 'Hospitalised on first birthday',
      value: 'Hospitalised on first birthday',
    },
    { label: 'N/A', value: 'N/A' },
    { label: 'Unknown', value: 'Unknown' },
  ];
  ...
  ngOnInit(): void {
    ...
    if (id) {
      ...
      const param = this.activeRoute.snapshot.queryParams['verify'];
      if (param) {
        this.isVerify = true;
      }
    }
    ...
    this.sharedService.editable$.subscribe((editable) => {
      if (
        (editable || this.patientForm.get('id')!.value === EMPTY_GUID) &&
        !this.isAdmin()
      ) {
